    ...
    render(){
        return(
            <ScrollView
                ...
                <Text
                    style={{fontWeight: 'bold', fontSize: 20, padding: 15}}>Privacy Policy</Text>
                <Text
